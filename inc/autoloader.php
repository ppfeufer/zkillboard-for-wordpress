...
namespace WordPress\Plugins\ZkillboardForWordPress;

\spl_autoload_register('\WordPress\Plugins\ZkillboardForWordPress\autoload');

function autoload($className) {
    // If the specified $className does not include our namespace, duck out.
    if(\strpos($className, 'WordPress\Plugins\ZkillboardForWordPress') === false) {
        return;
    }
